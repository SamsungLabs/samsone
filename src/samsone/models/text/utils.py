...
# From: https://github.com/pytorch/executorch/blob/main/examples/models/llama/source_transformation/prune_vocab.py
...
def prune_output_vocab(
    ...
    Returns:
        The pruned model.
    """
    assert hasattr(model, output_layer_name), (
